...
CREATE TABLE ResultadoProva (
    ...
    CONSTRAINT FK_RESULTADOPROVA1 FOREIGN KEY(aluno) REFERENCES Aluno(cpf) ON DELETE CASCADE,
    CONSTRAINT FK_RESULTADOPROVA2 FOREIGN KEY(id_turma, numero) REFERENCES Prova(id_turma, numero) ON DELETE CASCADE
);
